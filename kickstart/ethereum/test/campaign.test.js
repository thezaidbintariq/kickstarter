//importing the assert/ganache/Web3 module
...
beforeEach(async () => {
    ...
    await campaignFactory.methods.createCampaign('100').send({
        from: accounts[0],
        gas: '1000000'  //gas is the amount of gas to be used
    });
    
    //getting the address of the contract and storing it in the campaignAddress variable
    //assuming that the address of the contract is the first element in the array
